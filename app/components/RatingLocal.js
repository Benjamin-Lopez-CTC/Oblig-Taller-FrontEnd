            ...
            <div className="bg-white rounded-2xl shadow-lg p-8 w-full max-w-sm text-center">
                ...
                {!submitted ? (
                    <>
                        ...
                        <p className="text-emerald-500 font-medium h-6 text-sm mb-6">
                        ...
                        <textarea
                            ...
                            rows={3}
                            className="w-full rounded-xl border border-gray-200 p-3 text-sm text-gray-700 resize-none focus:outline-none focus:ring-2 focus:ring-emerald-300 mb-4"
                        />
                        <button
                            ...
                            style={{
                                background:
                                    rating > 0
                                        ? "linear-gradient(135deg, #00d492, #00786F)"
                                        : "#e5e7eb",
